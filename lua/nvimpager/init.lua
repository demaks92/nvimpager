...
-- if vim.g.loaded_nvimpager == 1 then
-- 	return
-- end
...
local nvimpager = {
	...
	git_colors = true, -- if the highlighting from the git should be used
}
...
local function set_maps()
	...
	local nvimpager_mappings = utils.load_config().mappings.nvimpager
	utils.load_mappings({ nvimpager_mappings }, { buffer = bufnr })
end
